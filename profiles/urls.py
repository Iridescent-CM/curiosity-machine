...
urlpatterns = patterns('profiles.views',
    ...
    url(r'^join/(?P<source>[^/]+)/$', views.student.join, name='join'),
    url(r'^join_as_mentor/$', views.mentor.join, name='join_as_mentor'),
    url(r'^join_as_mentor/(?P<source>[^/]+)/$', views.mentor.join, name='join_as_mentor'),
    ...
    url(r'^mentors/$', whitelist('unapproved_mentors')(views.mentor.list_all), name='mentors'),
    url(r'^mentors/(?P<username>[^/]+)/$', whitelist('unapproved_mentors')(views.mentor.show_profile), name='mentor_profile'),
