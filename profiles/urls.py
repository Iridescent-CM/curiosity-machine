...
urlpatterns = patterns('profiles.views',
    ...
    url(r'^home/students/$', whitelist('unapproved_mentors')(views.educator.students_dashboard), name='educator_dashboard_students'),
    url(r'^home/guides/$', whitelist('unapproved_mentors')(views.educator.guides_dashboard), name='educator_dashboard_guides'),
