...
class User(AbstractBaseUser, PermissionsMixin):
    ''' User class based on AbstractUser, with some modifications like a longer email field and support for legacy
        passwords.'''
    ...
    role = models.SmallIntegerField(choices=Role.ALL_CHOICES,default=Role.STUDENT)
