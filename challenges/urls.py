...
urlpatterns = patterns('challenges.views',
    ...
    url(r'^(?P<challenge_id>\d+)/examples/add/$', views.add_example, name='add_example'),
    url(r'^(?P<challenge_id>\d+)/examples-approval/$', views.examples_approval, name='examples-approval'),
